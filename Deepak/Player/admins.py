from Deepak.helpers.admins import admins
from Deepak.main import call_py
from pyrogram import filters
from Deepak.main import bot as Client
from Deepak.decorators import authorized_users_only
from Deepak.filters import command, other_filters
from Deepak.queues import QUEUE, clear_queue
from Deepak.utils import skip_current_song, skip_item
...
from Deepak.filters import command
...
async def update_admin(client, message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/e85f9502055ff9755d9bc.jpg", 
...
async def pause(client, m: Message):
    ...
    if chat_id in QUEUE:
        ...
        await m.reply("**🥀 Nᴏᴛʜɪɴɢ Iɴ Sᴛʀᴇᴀᴍɪɴɢ**")
...
async def mute(client, m: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            await m.reply_photo(
                             photo="https://te.legra.ph/file/e9ff6039c8fc1d895e1a7.jpg", 
                             caption="🔇 **Uѕєявσт Mυтє∂**\n\n🥀 **Tσ Uηмυтє Tнє Usєявσт, Usє Tнє**\n🥀 Cσммαη∂ `.unmute`**"
    )
        except Exception as e:
            await m.reply(f"🚫 **error:**\n\n`{e}`")
    else:
...
async def unmute(client, m: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            await m.reply_photo(
                             photo="https://te.legra.ph/file/115d5429cf2d39bc23741.jpg", 
                             caption="🔊 **Usєявσт Uηмυтє∂**\n\n🥀 **Tσ Mυтє Tнє Usєявσт, Usє Tнє**\n🥀 Cσммαη∂ `.mute`**"
    )
        except Exception as e:
            await m.reply(f"🚫 **error:**\n\n`{e}`")
    else:
