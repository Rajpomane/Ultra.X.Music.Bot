...
from Deepak.Player.callback import stream_markup
from Deepak.resources.thumbnail import thumb
from Deepak.resources.chatname import CHAT_TITLE
    ...
    if replied:
        if replied.video or replied.document:
            ...
            if len(m.command) < 2:
                ...
                loser = await c.send_message(chat_id, "**🔄 Pʀᴏᴄᴇssɪɴɢ Qᴜᴇʀʏ.... Pʟᴇᴀsᴇ Wᴀɪᴛ!**")
        ...
        if len(m.command) < 2:
            await m.reply_text(f"Usage: /vplay [Music Name or Youtube Link or Reply to Audio]")
