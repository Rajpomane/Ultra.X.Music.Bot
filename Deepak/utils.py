import os
import asyncio
from Deepak.main import bot, call_py
from pytgcalls.types import Update
from pytgcalls.types.input_stream import AudioPiped, AudioVideoPiped
from Deepak.queues import QUEUE, clear_queue, get_queue, pop_an_item
...
keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(text="🥀• ɱəɳʉ 🥀", callback_data="cbmenu"),                
                InlineKeyboardButton(text="🥀• ɔʍɳəɽ 🥀", url=f"https://t.me/OFFICIALHACKERERA"),
            ]
        ]
    )
